...
async function setTenantContext(tenantId, operatorId) {
...
async function main() {
    ...
    const superAdmin = await prisma.commandOperator.upsert({
        ...
        create: {
            ...
            role: client_core_1.CommandOperatorRole.SUPER_ADMIN,
            ...
            mfaEnabled: false,
            status: client_core_1.EntityStatus.ACTIVE,
        },
    });
  ...
  `);
    ...
    const orientationPrompt = await prisma.iaPrompt.upsert({
        ...
        create: {
            ...
            moduleTarget: client_core_1.YiraModule.YIRA_OS, agentName: 'VIEUX_PERE_ORIENTATION_AGENT',
            ...
            version: 1, status: client_core_1.EntityStatus.ACTIVE, createdById: superAdmin.id,
        },
    });
    ...
    const refFiliereRoot = await prisma.referential.upsert({
        where: { tenantId_refType_refCode: { tenantId: 'CI', refType: client_core_1.ReferentialType.FILIERE, refCode: 'SECONDAIRE_CI' } },
        update: {},
        create: { tenantId: 'CI', refType: client_core_1.ReferentialType.FILIERE, refCode: 'SECONDAIRE_CI', labelFr: "Filieres du secondaire - Cote d'Ivoire", labelLocal: "Filieres secondaire CI", metadata: { source: 'MENET-DOB', annee: 2026 }, sortOrder: 0, status: client_core_1.EntityStatus.ACTIVE },
    });
    const filieres = [
    ...
    for (const [index, filiere] of filieres.entries()) {
        await prisma.referential.upsert({
            where: { tenantId_refType_refCode: { tenantId: 'CI', refType: client_core_1.ReferentialType.FILIERE, refCode: filiere.refCode } },
            update: {},
            create: { tenantId: 'CI', refType: client_core_1.ReferentialType.FILIERE, refCode: filiere.refCode, labelFr: filiere.labelFr, labelLocal: filiere.labelFr, metadata: filiere.metadata, sortOrder: index + 1, parentId: refFiliereRoot.id, status: client_core_1.EntityStatus.ACTIVE },
        });
    }
    ...
    await prisma.yiraConfigService.upsert({
        ...
        create: {
            ...
            ussdPath: '1*1', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT,
            ...
            doubleOptinRequired: true, isFreemium: false, status: client_core_1.EntityStatus.ACTIVE,
        },
    });
    await setTenantContext('CI', superAdmin.id);
    const menusUssd = [
    ...
    for (const menu of menusUssd) {
        await prisma.referential.upsert({
            where: { tenantId_refType_refCode: { tenantId: 'CI', refType: client_core_1.ReferentialType.METIER, refCode: menu.refCode } },
            update: { labelFr: menu.labelFr },
            create: { tenantId: 'CI', refType: client_core_1.ReferentialType.METIER, refCode: menu.refCode, labelFr: menu.labelFr, labelLocal: menu.labelFr, metadata: menu.metadata, sortOrder: menu.metadata.ordre ?? 0, status: client_core_1.EntityStatus.ACTIVE },
        });
    }
    console.log('OK Menus USSD crees : ' + menusUssd.length + ' referentiels');
    const services = [
        { serviceCode: 'CULTURE', serviceName: 'CultureQuizX', ussdPath: '1*2', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 50, gratuit: false },
        { serviceCode: 'SPORT', serviceName: 'Sport-Quiz', ussdPath: '1*3', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 50, gratuit: false },
        { serviceCode: 'PROVERBE', serviceName: 'ProverbeQuiz', ussdPath: '1*4', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 50, gratuit: false },
        { serviceCode: 'QUIZIK', serviceName: 'QuiZik Musique', ussdPath: '1*5', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 50, gratuit: false },
        { serviceCode: 'CUISINE', serviceName: 'Cuisine-Quiz', ussdPath: '1*6', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 50, gratuit: false },
        { serviceCode: 'EDU', serviceName: 'Quiz-Edu BEPC/BAC', ussdPath: '1*7', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'ALPHA', serviceName: 'Alpha-Quiz', ussdPath: '1*8', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'HISTOIRE', serviceName: 'Quiz Histoire CI', ussdPath: '1*9', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 50, gratuit: false },
        { serviceCode: 'PALU', serviceName: 'Quiz Paludisme', ussdPath: '2*1', vasGroup: client_core_1.VasGroup.GROUP_D_SANTE, prix: 0, gratuit: true },
        { serviceCode: 'DEPIST', serviceName: 'Centres Depistage', ussdPath: '2*2', vasGroup: client_core_1.VasGroup.GROUP_D_SANTE, prix: 0, gratuit: true },
        { serviceCode: 'MAMA', serviceName: 'Mama-Quiz', ussdPath: '2*3', vasGroup: client_core_1.VasGroup.GROUP_B_FREEMIUM, prix: 0, gratuit: false },
        { serviceCode: 'VACCIN', serviceName: 'Vaccin-Quiz', ussdPath: '2*4', vasGroup: client_core_1.VasGroup.GROUP_B_FREEMIUM, prix: 0, gratuit: false },
        { serviceCode: 'NUTRI', serviceName: 'Nutri-Quiz', ussdPath: '2*5', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'HYGIENE', serviceName: 'Hygiene-Quiz', ussdPath: '2*6', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'EAU', serviceName: 'Eau-Quiz WASH', ussdPath: '2*7', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'CANCER', serviceName: 'Prevention Cancer', ussdPath: '2*8', vasGroup: client_core_1.VasGroup.GROUP_D_SANTE, prix: 0, gratuit: true },
        { serviceCode: 'ESPRIT', serviceName: 'Sante Mentale', ussdPath: '2*9', vasGroup: client_core_1.VasGroup.GROUP_D_SANTE, prix: 0, gratuit: true },
        { serviceCode: 'HANDICAP', serviceName: 'Quiz Handicap', ussdPath: '2*10', vasGroup: client_core_1.VasGroup.GROUP_D_SANTE, prix: 0, gratuit: true },
        { serviceCode: 'AGRI', serviceName: 'Agri-Quiz', ussdPath: '3*1', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'METEO', serviceName: 'Meteo-Agri', ussdPath: '3*2', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'FINANCE', serviceName: 'Finance-Quiz', ussdPath: '3*3', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'MICRO', serviceName: 'Micro-Quiz', ussdPath: '3*4', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'ACTUQUIZ', serviceName: 'ActuQuiz CI', ussdPath: '3*5', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 75, gratuit: false },
        { serviceCode: 'SECURITE', serviceName: 'InfoSecurite', ussdPath: '3*6', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 50, gratuit: false },
        { serviceCode: 'ORIENTATION', serviceName: 'YIRA-Orientation', ussdPath: '4*1', vasGroup: client_core_1.VasGroup.GROUP_B_FREEMIUM, prix: 0, gratuit: false },
        { serviceCode: 'EMPLOI', serviceName: 'Offres Emploi CI', ussdPath: '4*2', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 75, gratuit: false },
        { serviceCode: 'ROUTE', serviceName: 'Route-Quiz Permis', ussdPath: '4*3', vasGroup: client_core_1.VasGroup.GROUP_B_FREEMIUM, prix: 0, gratuit: false },
        { serviceCode: 'DROIT', serviceName: 'Droit-Quiz', ussdPath: '4*4', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'FEMME', serviceName: 'Femme-Quiz', ussdPath: '4*5', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'ELECTION', serviceName: 'Election & CEI', ussdPath: '4*6', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'ARNAQUE', serviceName: 'Anti-Arnaque', ussdPath: '4*7', vasGroup: client_core_1.VasGroup.GROUP_D_SANTE, prix: 0, gratuit: true },
        { serviceCode: 'CONCOURS', serviceName: 'Concours FP CI', ussdPath: '4*8', vasGroup: client_core_1.VasGroup.GROUP_A_PAYANT, prix: 50, gratuit: false },
        { serviceCode: 'SENIOR', serviceName: 'Droits Seniors', ussdPath: '4*9', vasGroup: client_core_1.VasGroup.GROUP_D_SANTE, prix: 0, gratuit: true },
        { serviceCode: 'TRAVAIL', serviceName: 'Droit du Travail', ussdPath: '4*10', vasGroup: client_core_1.VasGroup.GROUP_C_GRATUIT, prix: 0, gratuit: true },
        { serviceCode: 'VOD', serviceName: 'VOD-Quiz Educatif', ussdPath: '4*11', vasGroup: client_core_1.VasGroup.GROUP_E_VOD, prix: 75, gratuit: false },
        { serviceCode: 'SOS', serviceName: 'SOS-YIRA Urgence', ussdPath: '5*1', vasGroup: client_core_1.VasGroup.GROUP_F_SOS, prix: 0, gratuit: true },
    ];
    let createdCount = 0;
    for (const svc of services) {
        await prisma.yiraConfigService.upsert({
            ...
            create: {
                ...
                isFreemium: svc.vasGroup === client_core_1.VasGroup.GROUP_B_FREEMIUM,
    ...
    for (const regle of reglesMod) {
        await prisma.referential.upsert({
            where: { tenantId_refType_refCode: { tenantId: 'CI', refType: client_core_1.ReferentialType.METIER, refCode: regle.refCode } },
            update: { metadata: regle.metadata },
            create: { tenantId: 'CI', refType: client_core_1.ReferentialType.METIER, refCode: regle.refCode, labelFr: regle.labelFr, labelLocal: regle.labelFr, metadata: regle.metadata, sortOrder: 0, status: client_core_1.EntityStatus.ACTIVE },
        });
    }
...
//# sourceMappingURL=seed-base-core.js.map